...
public class EditTextSwitchPreference extends EditTextPreference {
	...
	public EditTextSwitchPreference(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			EditTextSwitchKeyDefaultValue =
				valueArray.getBoolean(R.styleable.EditTextSwitchPreference_editTextSwitchKeyDefaultValue, false);
			valueArray.recycle();
		}
	}
	...
	public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
		...
		if ((EditTextSwitchKey != null)) {
			switch (EditTextSwitchKey) {
				...
				case "filter_02":
					holder.itemView.setBackgroundColor(
						ResourcesCompat.getColor(context.getResources(), R.color.pink, null));
					break;
				case "filter_03":
					holder.itemView.setBackgroundColor(
						ResourcesCompat.getColor(context.getResources(), R.color.purple, null));
					break;
				case "filter_04":
					holder.itemView.setBackgroundColor(
				...
				case "filter_05":
					holder.itemView.setBackgroundColor(
						ResourcesCompat.getColor(context.getResources(), R.color.teal, null));
					break;
				case "filter_06":
					holder.itemView.setBackgroundColor(
				...
				case "filter_07":
					holder.itemView.setBackgroundColor(
						ResourcesCompat.getColor(context.getResources(), R.color.lime, null));
					break;
				case "filter_08":
					holder.itemView.setBackgroundColor(
						ResourcesCompat.getColor(context.getResources(), R.color.yellow, null));
					break;
				case "filter_09":
					holder.itemView.setBackgroundColor(
						ResourcesCompat.getColor(context.getResources(), R.color.orange, null));
					break;
				case "filter_10":
					holder.itemView.setBackgroundColor(
						ResourcesCompat.getColor(context.getResources(), R.color.brown, null));
					break;
				case "filter_11":
					holder.itemView.setBackgroundColor(
